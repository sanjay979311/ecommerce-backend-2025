...
import express from 'express';
import serverless from 'serverless-http'; // <--- Serverless support for Vercel
...
// Dynamic CORS: allow based on environment
const allowedOrigins = [
  process.env.DOMAIN_LOCAL || 'http://localhost:5173',
  process.env.DOMAIL_PROD || 'https://ecommerce-backend-2025.vercel.app'
];
app.use(cors({
